...
8. Remove text from image by HTTP request `http://127.0.0.1:8000/text_detection/?url=https://img-9gag-fun.9cache.com/photo/axMNd31_460s.jpg` (IP and port will print in console when you start up service *step 7*. url= -- URL to original image).
